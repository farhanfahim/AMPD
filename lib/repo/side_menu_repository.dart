...
class SideMenuRepository {
  ...
  factory SideMenuRepository({@required AppPreferences appPreferences}) =>
      SideMenuRepository._internal(appPreferences);

  SideMenuRepository._internal(this._appPreferences);
