...
class TermsConditionRepository {
  ...
  factory TermsConditionRepository({@required AppPreferences appPreferences}) =>
      TermsConditionRepository._internal(appPreferences);

  TermsConditionRepository._internal(this._appPreferences);
  ...
  void getPage(Map<String, dynamic> map){
    ...
    _appPreferences.getAccessToken().then((value) {
      ...
      NetworkNAO.getTermsPage(value, map).then((response) async {
